// app/analysis/_components/SupplierRiskTable.tsx
'use client'
...
import { AlertTriangle, Leaf, Fuel, ArrowRightLeft } from 'lucide-react'
...
export function SupplierRiskTable(props: SupplierRiskTableProps) {
  ...
  const [changeSheetRow, setChangeSheetRow] = useState<SupplierRiskRow | null>(null)
  ...
  return (
    <>
      ...
      <UnifiedChangeSheet
        row={changeSheetRow}
        onClose={() => setChangeSheetRow(null)}
      />
    </>
  )
}